...
COINS_SAVED = [
    '1000BONKUSDT', 'ONDOUSDT', 'VIRTUALUSDT',
...
# 28 coin: hapus XVGUSDT, ONDOUSDT, SANDUSDT; kembalikan semua yang pernah dihapus
COINS = [
    # Batch 1
    '1000BONKUSDT', 'BERAUSDT', '1000PEPEUSDT',
    'ENAUSDT', 'SHIB1000USDT', 'JUPUSDT',
    'OPUSDT', 'ALGOUSDT', 'ORCAUSDT',
    'XRPUSDT', 'XAUTUSDT', 'FARTCOINUSDT', 'TAOUSDT',
    # Batch 2
    'SOLUSDT', 'SUIUSDT', 'TIAUSDT', 'AAVEUSDT', 'GALAUSDT',
    'IMXUSDT', 'GMXUSDT', 'AXSUSDT',
    'LTCUSDT', 'DYDXUSDT', 'ICPUSDT',
    # Batch 3
    'BELUSDT', 'VIRTUALUSDT', 'SEIUSDT', 'HBARUSDT',
]

...
# 17 coin: hapus SEIUSDT, DYDXUSDT, AXSUSDT, IMXUSDT, SUIUSDT, XAUTUSDT,
#          FARTCOINUSDT, OPUSDT, ALGOUSDT, 1000PEPEUSDT, ENAUSDT
COINS = [
    '1000BONKUSDT', 'BERAUSDT', 'SHIB1000USDT', 'JUPUSDT',
    'ORCAUSDT', 'XRPUSDT', 'TAOUSDT',
    'SOLUSDT', 'TIAUSDT', 'AAVEUSDT', 'GALAUSDT',
    'GMXUSDT', 'LTCUSDT', 'ICPUSDT',
    'BELUSDT', 'VIRTUALUSDT', 'HBARUSDT',
]
